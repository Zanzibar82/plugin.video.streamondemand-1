...
def getmainlist(preferred_thumb=""):
    ...
    itemlist.append( Item(title=config.get_localized_string(30131) , channel="library" , action="mainlist", thumbnail = os.path.join(config.get_runtime_path() , "resources" , "images", "main_menu_library.png"),viewmode="movie") )
