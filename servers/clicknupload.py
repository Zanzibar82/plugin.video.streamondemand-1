...
def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    logger.info("streamondemand.servers.clicknupload url="+page_url)
    ...
    for video_url in video_urls:
        logger.info("streamondemand.servers.clicknupload %s - %s" % (video_url[0],video_url[1]))
...
def find_videos(data):
    ...
    logger.info("streamondemand.servers.clicknupload find_videos #"+patronvideos+"#")
